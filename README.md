...
|-----|------|-------------|------|
| 1 | 20 Mar 2026 | Environment setup (pyenv + uv + VS Code). NumPy: arrays, vectorisation, broadcasting, 1M-element benchmark. | [Notebook](day01_numpy_basics/day01_numpy_practice.ipynb) |
